...
SimpleDataSupplier::SimpleDataSupplier(int _pointsSqrt, double _distance, double _mass) :
        DataSupplier(_pointsSqrt * _pointsSqrt), distance(_distance), pointsSqrt(_pointsSqrt), mass(_mass)
{
}
